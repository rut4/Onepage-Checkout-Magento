 ...
 */
class Oggetto_OnepageCheckout_Model_Source_LayoutColumns
{
    /**
     * Get options
     *
    ...
    {
        return [
            ['value' => 2, 'label' => Mage::helper('onepageCheckout')->__('2 columns')],
            ['value' => 3, 'label' => Mage::helper('onepageCheckout')->__('3 columns')]
        ];
    }
}
