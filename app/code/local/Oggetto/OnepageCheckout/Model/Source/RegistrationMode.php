 ...
 */
class Oggetto_OnepageCheckout_Model_Source_RegistrationMode
{
    /**
     * Get options
     *
    ...
    {
        return [
            ['value' => 1, 'label' => Mage::helper('onepageCheckout')->__('Guest checkout is allowed')],
            ['value' => 0, 'label' => Mage::helper('onepageCheckout')->__('Only registered user checkout is allowed')]
        ];
    }
}
