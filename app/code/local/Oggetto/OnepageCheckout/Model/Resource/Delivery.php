 ...
 */
class Oggetto_OnepageCheckout_Model_Resource_Delivery extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('onepageCheckout/delivery', 'delivery_id');
    }
}
